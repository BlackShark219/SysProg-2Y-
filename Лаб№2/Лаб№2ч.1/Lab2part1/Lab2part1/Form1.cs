...
namespace Lab2part1
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'car_SpecificationDataSet.DetailD' table. You can move, or remove it, as needed.
            this.detailDTableAdapter.Fill(this.car_SpecificationDataSet.DetailD);
                            ...
                            if (PassFormatInt(textBox5.Text) || radioButtonGet.Checked || radioButtonDelete.Checked)
                            {
                                ...
                                using (CarSpecificationEntities db = new CarSpecificationEntities())
                                {
                                    ...
                                    if (radioButtonGet.Checked & checkBoxID.Checked == false & checkBoxPART_ID.Checked == false)
                                    {
                                        ...
                                        result.Text = $"{det.ToList().Count} row(s) displayed";
                                    ...
                                    if (radioButtonGet.Checked & checkBoxID.Checked)
                                    {
                                        ...
                                        result.Text = $"{row.ToList().Count} row(s) displayed";
